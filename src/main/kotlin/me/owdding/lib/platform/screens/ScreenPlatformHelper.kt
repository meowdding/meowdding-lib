...
internal fun McCharacterEvent.into() = CharacterEvent(this.codepoint, /*? >= 26.1 { */ 0 /*? } else { *//*this.modifiers*//*? } */)
...
internal fun CharacterEvent.into() = McCharacterEvent(this.codepoint/*? < 26.1 >> ')'*//*, this.modifiers*/)
